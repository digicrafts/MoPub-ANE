    ...
    private class HTML5WebChromeClient extends WebChromeClient implements OnCompletionListener, 
        ...
        public Bitmap getDefaultVideoPoster() { 
            if (mDefaultVideoPoster == null) {
                mDefaultVideoPoster = BitmapFactory.decodeResource(
                        getResources(), MoPub.getResourseIdByName(getContext().getPackageName(),"drawable","default_video_poster"));
            }
        ...
        public View getVideoLoadingProgressView() {
            if (mVideoProgressView == null) {
                ...
                mVideoProgressView = inflater.inflate(MoPub.getResourseIdByName(getContext().getPackageName(),"layout","video_loading_progress"), null);
            }
